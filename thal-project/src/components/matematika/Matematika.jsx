...
const Matematika = () => {
  ...
  const handleDetailClick = () => {
    navigate('/detail', { state: { userData } });
  };
        ...
        <div className="dashboard-container">
          ...
          <div className="right-container">
            <div className="top-container">
              <a onClick={handleBackClick}><i className="fas fa-arrow-left"></i> Dashboard <span>Matematika</span></a>
            </div>
            <div className="bottom-container">
              <div className="bottom-container-header">
                <div className="bottom-container-header-img">
                  <img className="logo" src={mathImg} alt="matematika" />
                </div>
